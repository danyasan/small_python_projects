...
View code at https://nostarch.com/big-book-small-python-projects
...
while True: # Main game loop.
    ...
    print(f"{JAPANESE_NUMBERS[dice1]} - {JAPANESE_NUMBERS[dice2]}".center(30))
    print(f"{dice1} - {dice2}".center(30))
    ...
    # Chec if the player has run out of money:
    if purse == 0:
